...
def get_files(file_folder='', file_format='file_%d.csv'):
	...
	Usage:
		files = get_files('/zfs/dicelab/farah/query_exp/query-construction2/Baltimore/interval/file_pro/', 'file_%d.csv')
...
def build_args():
	...
	parser.add_argument("--input_folder",\
			    ...
			    type=str,\
			    default="/zfs/dicelab/farah/query_exp/query-construction2/Baltimore/interval/file_pro/")
...
def calculate_DEC(P=5, input_files=[], output_folder=''):
	...
	for interval, f in enumerate(input_files):
		...
		outfile = output_folder + 'ecentrality%d.txt' % (interval + 738)
