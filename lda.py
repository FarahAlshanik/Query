...
def build_args():
	...
	parser.add_argument("--input_folder",\
			    ...
			    type=str,\
			    default="/zfs/dicelab/farah/query_exp/query-construction2/Boston/lda/lda_files")

	parser.add_argument("--output_folder", help="location of output files", type=str, default='/zfs/dicelab/farah/query_exp/query-construction2/Boston/lda/lda_output')
