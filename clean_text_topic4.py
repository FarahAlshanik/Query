...
def get_files(file_folder='', file_format='topic4_file_%d.csv'): #file_format='file_%d.csv'
	"""
	...
	Usage:
		...
		files = get_files('/zfs/dicelab/farah/query_exp/query-construction2/Baltimore/step1_lda/topic4/', 'topic4_file_%d.csv')
...
def build_args():
	...
	parser.add_argument("--input_folder",\
			    ...
			    type=str,\
			    default="/zfs/dicelab/farah/query_exp/query-construction2/Baltimore/step1_lda/topic4/") #default="/zfs/dicelab/farah/query_exp/query-construction2/Baltimore/lda_files/

	parser.add_argument("--output_folder", help="location of output files", type=str, default='/zfs/dicelab/farah/query_exp/query-construction2/Baltimore/step1_lda/lda_files_topic4/') #/Baltimore/lda_clean_files/
