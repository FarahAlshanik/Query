...
dis2 = open('/zfs/dicelab/farah/query_exp/query-construction2/entropy_tweet_sliding_window_jacard2.txt', 'w')
...
def similarities_vectorized2(vector_data,mm,y):
    sim=[]
...
def similarities_vectorized(vector_data,mm,y):
    sim=[]
...
simlar=[]
for i in range(int(len(wind)/2)):
    #print(i)
    p1 = Process(target=similarities_vectorized,args=(np.asarray(wind[i]),wind[i],i))
    p1.start()
    #print(p1)
...
for i in range(int(len(wind)/2),len(wind)):
    #print(i)
    p2 = Process(target=similarities_vectorized2,args=(np.asarray(wind[i]),wind[i],i))
    p2.start()
    #print(p2)
    #similarity = similarities_vectorized(np.asarray(wind[i]),wind[i])
    #simlar.append(similarity)
...
dis2.close()
'''
diss = open('/zfs/dicelab/farah/query_exp/query-construction2/entropy_tweet_sliding_window_jacard.txt', 'r')
diss2= open('/zfs/dicelab/farah/query_exp/query-construction2/entropy_tweet_sliding_window_jacard2.txt', 'r')
