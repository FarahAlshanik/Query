...
for q in range(len(final_cent_array_file_all)-1):
    for i in final_cent_array_file_all[idf_file[y]]:
        sum_=0
        l=0
        for j in final_cent_array_file_all[idf_file[w]]:
        #cos_sim(i,j)
...
#cen_idf_file_0=sum(final_cent_array_file_all[idf_file[0]])
#cen_idf_file_0=cen_idf_file_0/len(final_cent_array_file_all[idf_file[0]])
#cen_idf_file_1=sum(final_cent_array_file_all[idf_file[1]])
#cen_idf_file_1=cen_idf_file_1/len(final_cent_array_file_all[idf_file[1]]) 


#print(1-spatial.distance.cosine(cen_idf_file_0, cen_idf_file_1))

#cen_idf_file_2=sum(final_cent_array_file_all[idf_file[2]])
#cen_idf_file_2=cen_idf_file_2/len(final_cent_array_file_all[idf_file[2]])

#print(1-spatial.distance.cosine(cen_idf_file_1, cen_idf_file_2))

    
    
dis = open('similarity_new_sample.txt', 'w')
for item in r:
  dis.write("%s\n" % item)
dis.close()
