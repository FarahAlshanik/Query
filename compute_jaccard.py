...
def get_files(file_folder='', file_format='ecentrality%d.txt'):
	...
	Usage:
		#files = get_files('/zfs/dicelab/farah/query_exp/query-construction2/Baltimore/dec_vals_new2/', 'file_%d.csv')
		files = get_files('/zfs/dicelab/farah/Baltimore/dec_vals_new2/', 'file_%d.csv')
...
def build_args():
   ...
   # parser.add_argument("--output_file", help="output file for emerging windows", type=str, default='/zfs/dicelab/farah/query_exp/query-construction2/Baltimore/jac/emerging_windows.txt')
    parser.add_argument("--output_file", help="output file for emerging windows", type=str, default='/zfs/dicelab/farah/Baltimore/jac/emerging_windows.txt')
