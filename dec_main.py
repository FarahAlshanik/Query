...
def get_files(file_folder='', file_format='file_%d.csv'):
	...
	Usage:
		#files = get_files('/zfs/dicelab/farah/query_exp/query-construction2/Baltimore/interval/int/', 'file_%d.csv')
                ...
                files=get_files('/zfs/dicelab/farah/break_police_15M/', 'file_%d.csv')
...
def build_args():
	...
	parser.add_argument("--input_folder",\
			    ...
			    type=str,\
			    default="/zfs/dicelab/farah/break_police_15M/")

	#parser.add_argument("--output_folder", help="location of output files", type=str, default='/zfs/dicelab/farah/query_exp/query-construction2/Baltimore/dec_vals_new2/')
	#parser.add_argument("--output_folder", help="location of output files", type=str, default='/zfs/dicelab/farah/Baltimore/dec_vals_new2/')
	parser.add_argument("--output_folder", help="location of output files", type=str, default='/zfs/dicelab/farah/dec_domain/')
