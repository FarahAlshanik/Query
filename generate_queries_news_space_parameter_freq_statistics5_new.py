...
def main(args):
  ...
  print(" words in both current and all tweets:  ",f_w)
  tweet_statistics.write("*******")
  tweet_statistics.write("number of words in current intervals and are already in tweets: "+str(len(list_future_words))+"    ")
  tweet_statistics.write("*******")
  tweet_statistics.write("*******")
  tweet_statistics.write("number of words not in current intervals but in future: "+str(len(list_t)-len(list_future_words))+"    ") #len of words in tweets - intersection between current and in give future
