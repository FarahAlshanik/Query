...
def get_files(file_folder='', file_format='topic1_file_%d.csv'):
        """
        ...
        files = get_files('/zfs/dicelab/farah/query_exp/query-construction2/Baltimore/step1_lda//plda_output_topic1/', 'topic1_file_%d.csv')
...
def build_args():
        ...
        parser.add_argument("--input_folder",\
                            ...
                            type=str,\
                            default="/zfs/dicelab/farah/query_exp/query-construction2/Baltimore/step1_lda/plda_output_topic1/") #Baltimore/plda_output_new/
        parser.add_argument("--output_folder", help="location of output files", type=str, default='/zfs/dicelab/farah/query_exp/query-construction2/Baltimore/step1_lda/plda_output_topic1_format/')
