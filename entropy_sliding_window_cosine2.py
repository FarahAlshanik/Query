...
dis = open('/zfs/dicelab/farah/query_exp/query-construction2/entropy_tweet_sliding_window_cosine2.txt', 'w')
for item in entr:
  dis.write("%s\n" % item)
dis.close()
...
plt.savefig('/zfs/dicelab/farah/query_exp/query-construction2/tweet_entropy_window_cosine2.jpg')
